...
interface MobileHeaderProps {
  ...
  district?: string;
  roleLabel?: string;
  /** @deprecated kept for helper screens that manage sidebar externally */
  ...
  /** @deprecated use activeTab+onNavigate instead; kept for helper screens */
...
export function MobileHeader({
  ...
  // When externalToggle is provided, let the parent control sidebar (helper screens).
  // Otherwise manage it internally and render MobileSidebar here.
  const isExternallyControlled = externalToggle !== undefined;
  const isSidebarOpen = isExternallyControlled ? (externalSidebarOpen ?? false) : internalSidebarOpen;
  const toggleSidebar = isExternallyControlled
    ? externalToggle
  ...
  return (
    <>
      {/* Sidebar rendered internally when not externally controlled */}
      {!isExternallyControlled && activeTab && onNavigate && (
        <MobileSidebar
      ...
      <div className="bg-white shadow-sm sticky top-0 z-30">
        ...
        <div className="px-3 py-2.5 flex items-center gap-2">
          ...
          <button
            ...
            className="p-2 bg-amber-50 rounded-lg hover:bg-amber-100 transition-colors shrink-0"
          ...
          <button
            ...
            className="relative p-2 bg-amber-50 rounded-lg hover:bg-amber-100 transition-colors shrink-0"
          >
