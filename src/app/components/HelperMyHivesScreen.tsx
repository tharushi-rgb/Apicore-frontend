    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-emerald-50 to-amber-100 pb-24">
      ...
      <div className="px-4 py-6 space-y-4">
        <div className="grid grid-cols-3 gap-2">
          <div className="bg-white rounded-xl p-3 shadow-sm text-center"><p className="text-xl font-bold text-stone-800">{hives.length}</p><p className="text-xs text-stone-500">Total</p></div>
