        ...
        <div className="flex-1 flex flex-col items-center justify-center px-[6%] pb-[2rem] overflow-y-auto">
          <div className="max-w-md w-full">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                <label className="block text-stone-700 mb-2 font-medium">Email <span className="text-red-500">*</span></label>
              ...
              <div>
                <label className="block text-stone-700 mb-2 font-medium">Password <span className="text-red-500">*</span></label>
