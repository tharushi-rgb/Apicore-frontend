      ...
      <div className="flex-1 flex flex-col items-center justify-center px-[6%] pb-[2rem]">
        <div className="max-w-md w-full">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-stone-800 text-center">{t.title}</h1>
          </div>
            ...
            <form onSubmit={handleSubmit(onSubmitEmail)} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white border-2 border-stone-200 rounded-xl focus:border-amber-500 focus:outline-none"
          ...
          {stage === 'sent' && (
            <div className="space-y-4">
              <div className="bg-emerald-50 border-2 border-emerald-200 rounded-xl p-4 flex flex-col items-center text-center">
                ...
                <h2 className="text-emerald-900 font-bold text-lg mb-2">{t.checkEmail}</h2>
                <p className="text-emerald-700 text-sm">{t.emailSent}</p>
              </div>
